                ...
                <div className="flex h-screen bg-graphite text-white">
                    ...
                    <div className="flex-1 flex items-center justify-center p-8">
                        <div className="text-center">
                            <h1 className="text-4xl font-bold mb-4">Bem-vindo ao salvador do seu tempo</h1>
                            <p className="text-lg text-gray-300">
                                Selecione uma função no menu lateral, me diga o que precisa e vá dar uma enquanto eu trabalho para você!
                            </p>
                        </div>
                    </div>
